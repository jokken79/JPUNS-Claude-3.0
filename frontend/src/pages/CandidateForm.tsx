...
const CandidateForm: React.FC = () => {
  ...
  const fillWithDummyData = () => {
    setCandidate({
      full_name_kanji: faker.name.fullName(),
      full_name_kana: faker.name.fullName(),
      full_name_roman: faker.name.fullName(),
      date_of_birth: faker.date.past(30).toISOString().split('T')[0],
      gender: faker.helpers.arrayElement(['男性', '女性']),
      ...
      residence_expiry: faker.date.future(1).toISOString().split('T')[0],
      residence_card_number: faker.random.alphaNumeric(12).toUpperCase(),
      passport_number: faker.random.alphaNumeric(9).toUpperCase(),
      passport_expiry: faker.date.future(5).toISOString().split('T')[0],
      license_number: faker.random.alphaNumeric(12).toUpperCase(),
      license_expiry: faker.date.future(2).toISOString().split('T')[0],
      listening_level: faker.helpers.arrayElement(['beginner', 'intermediate', 'advanced']),
      speaking_level: faker.helpers.arrayElement(['beginner', 'intermediate', 'advanced']),
      reading_level: 'N2',
      writing_level: 'N3',
